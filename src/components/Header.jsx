...
const Header = ({ user, onLogout, taskStats }) => {
      ...
      <div className="max-w-6xl mx-auto px-4 py-4">
          ...
          <div className="flex items-center gap-6">
            <div className="hidden sm:flex items-center gap-4 text-sm">
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-600">{taskStats.total} Total</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-3 h-3 bg-green-500 rounded-full"></div>
                <span className="text-gray-600">{taskStats.completed} Done</span>
              </div>
              <div className="flex items-center gap-2">
        ...
        <div className="sm:hidden mt-4 pt-4 border-t border-gray-200">
          <div className="flex justify-between text-sm">
            ...
            <span className="text-gray-700 font-medium">{completionRate}% Complete</span>
          </div>
        </div>
      </div>
    </header>
